<?php 
    ...
    function register($emri, $mbiemri, $email, $telefoni, $ditelindja, $adresa, $username, $password)
    {
        $dbconn = connection();
        $sql = "INSERT INTO klientet (emri, mbiemri, ditelindja, email, telefoni, adresa, username, password)
        VALUE ('$emri', '$mbiemri', '$ditelindja', '$email', '$telefoni', '$adresa', '$username', '$password')";
    ...
    function modifikoKlient( $id, $emri, $mbiemri, $email, $telefoni ,$ditelindja, $adresa )
    {
        $dbconn = connection();
        $sql = "UPDATE klientet SET emri = '$emri', mbiemri = '$mbiemri', ditelindja = '$ditelindja', email = '$email', telefoni = '$telefoni', adresa = '$adresa' WHERE klientiid = $id";
        $result = mysqli_query($dbconn, $sql);
        if($result){
    ...
    function shtoKlient($emri, $mbiemri, $email, $telefoni, $ditelindja, $adresa)
    {
        $dbconn = connection();
        $sql = "INSERT INTO klientet (emri, mbiemri, ditelindja, email, telefoni, adresa)
        VALUE ('$emri', '$mbiemri', '$ditelindja', '$email', '$telefoni', '$adresa')";
        $result = mysqli_query($dbconn, $sql);
        if($result){
            header('Location: klientet.php');
        }   
