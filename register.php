...
<body style="background-color: #e8e8e8;">
    <div class="login-page" style="width: 600px;">
        ...
        <form class="login-form" id="loginForm" method="post">
            ...
            <input type="text" placeholder="Nr. Telefoni..." name="telefoni">
            <input type="text" placeholder="Ditelindja..." name="ditelindja">
            <input type="text" placeholder="Adresa..." name="adresa">
            <input type="text" placeholder="Username..." id="username" name="username" />
            <input type="password" placeholder="Password..." id="password" name="password" />
            <p style="margin-right: 33px;float:right">Keni account?<span style="color: #e8e8e8;"><a
